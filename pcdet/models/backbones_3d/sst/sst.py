...
class SSTInputLayer(nn.Module):
    ...
    def __init__(self,
        ...
        **kwargs):
        ...
        self.meta_drop_info = model_cfg.DROP_INFO
        self.shifts_list = model_cfg.SHIFTS_LIST
        self.shuffle_voxels = model_cfg.SHUFFLE_VOXELS
        self.debug = False
        self.window_shape = model_cfg.WINDOW_SHAPE
        self.num_point_features = None
        self.num_point_features_before_fusion = None
        model_cfg.SSTv1.window_shape = model_cfg.WINDOW_SHAPE
        model_cfg.SSTv1.drop_info = model_cfg.DROP_INFO
        self.sst_model = build_sst(model_cfg.SSTv1)
    ...
    def forward(self, batch_dict):
        ...
        self.set_drop_info()
        voxel_info = {}
        voxel_feat = batch_dict['pillar_features']
        ...
        batch_dict['voxel_feat'] = voxel_feat
        batch_dict['flat2win_inds_list'] = flat2win_inds_list
        batch_dict['voxel_info'] = voxel_info
        batch_dict = self.sst_model(batch_dict)
        return batch_dict
    ...
    def window_partition(self, coors, voxel_info):
        ...
        voxel_size = tuple(self.voxel_size) # using the min voxel size
